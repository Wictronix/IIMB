!(function (a) {
  ...
  a.magnificPopup.registerModule(P, {
    options: {
      markup:
        '<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe loading="lazy" class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen></iframe></div>',
      ...
      _preloadItem: function (c) {
        if (((c = S(c)), !b.items[c].preloaded)) {
          ...
          d.parsed || (d = b.parseEl(c)),
            y("LazyLoad", d),
            "image" === d.type &&
              (d.img = a('<img loading="lazy"class="mfp-img" />')
